...
from rl_algorithms2.sac_v2_lstm_share import SAC_Trainer, replay_buffer
trainer = SAC_Trainer(
...
model_type = "rsac_share"
continue_train = False
if continue_train:
    train_id = "230707000000" # Put the train_id and episode here !!!
    episode = "10000"
