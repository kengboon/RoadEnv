...
from road_env.envs.common.action import action_factory, Action, DiscreteMetaAction, ActionType
from road_env.envs.common.observation import observation_factory, ObservationType
from road_env.envs.common.finite_mdp import finite_mdp
from road_env.envs.common.graphics import EnvViewer
...
class AbstractEnv(gym.Env):
    ...
    def default_config(cls) -> dict:
        ...
        return {
            ...
            "other_vehicles_type": "road_env.vehicle.behavior.IDMVehicle",
            "screen_width": 600,  # [px]
    ...
    def change_vehicles(self, vehicle_class_path: str) -> 'AbstractEnv':
        ...
        :param vehicle_class_path: The path of the class of behavior for other vehicles
                             Example: "road_env.vehicle.behavior.IDMVehicle"
