...
from road_env.envs.common.action import ActionType, DiscreteMetaAction, ContinuousAction
from road_env.road.graphics import WorldSurface, RoadGraphics
from road_env.vehicle.graphics import VehicleGraphics

if TYPE_CHECKING:
    from road_env.envs import AbstractEnv
    from road_env.envs.common.abstract import Action
...
class EnvViewer(object):
    ...
    def __init__(self, env: 'AbstractEnv', config: Optional[dict] = None) -> None:
        ...
        pygame.init()
        pygame.display.set_caption("RoadEnv (highway-env)")
