...
from road_env.vehicle.behavior import IDMVehicle
...
class ActionType(object):
    ...
    def vehicle_class(self) -> Callable:
        ...
        Must return a subclass of :py:class:`road_env.vehicle.kinematics.Vehicle`.
        """
        raise NotImplementedError
    ...
    def act(self, action: Action) -> None:
        ...
        vehicle is an instance of the specified :py:class:`road_env.envs.common.action.ActionType.vehicle_class`.
